...
#include <dlo_msgs/srv/save_traj.hpp>
...
namespace dlo
{
  ...
  public:
    OdomNode(const std::string &node_name);
  ...
  private:
    ...
    bool saveTrajectory(const dlo_msgs::srv::SaveTraj::Request::SharedPtr req,
    ...
    rclcpp::Service<dlo_msgs::srv::SaveTraj>::SharedPtr save_traj_srv;
